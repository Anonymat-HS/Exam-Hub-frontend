  ...
  return (
    <div className="flex items-center justify-between pb-6 border-b border-gray-100 mb-8">
      ...
      {action && (
        <button
          onClick={action}
          className="inline-flex items-center gap-2 rounded-xl bg-primary-600 hover:bg-primary-700 px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-primary-200 transition-all active:scale-95 cursor-pointer"
        >
