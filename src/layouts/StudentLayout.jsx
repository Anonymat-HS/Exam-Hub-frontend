    ...
    <div className="flex h-screen overflow-hidden bg-gray-50 flex-col md:flex-row">
      ...
      `}>
        ...
        <button
          ...
          className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-gray-500 hover:text-red-500 hover:bg-red-50 transition-colors cursor-pointer"
        >
          <LogOut size={18} />
          Déconnexion
        </button>
